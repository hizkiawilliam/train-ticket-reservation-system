	...
	protected void doPost(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException
	{
		...
		try {
			...
			if(rs.next())
			{
			    ...
			    */
				...
				sct.setAttribute("ubean", ub);
					...
					rd.include(req, res);
					pw.println("<div class='main'><p1 class='menu'>Hello "+uName+" ! Selamat datang di web pemesanan tiket kereta!</p1></div>");
					pw.println("<div class='tab'>Disini anda dapat memeriksa detail Kereta, jadwal Kereta, harga tiket, dan informasi lainnya."+"</div>");
			...
			else
			{
				...
				pw.println("<div class='tab'><p1 class='menu'>Username dan Password salah!</p1></div>");
