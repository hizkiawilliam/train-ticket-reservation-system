			...
			if(!uName.equals("")||uName!=null) {
				try {
					...
					if(rs.next()) 
					{
						...
						rd.include(req, res);
						pw.println("<div class='main'><p1 class='menu'>Kereta Tersedia</p1></div>");
						pw.println("<div class='tab'><table><tr><th>Nama Kereta</th><th>Nomor Kereta</th>"
								+ "<th>Dari Stn</th><th>Ke Stn</th><th>Kursi Tersedia</th><th>Harga (IDR)</th></tr>");
						long trainNo;
						String fromStn;
						String toStn;
						do {
						...
						RequestDispatcher rd = req.getRequestDispatcher("ViewTrains.html");
						rd.include(req, res);
						pw.println("<div class='main'><p1 class='menu red'> Tidak ada Kereta yang berjalan!</p1></div>");
					}
				}
				catch(Exception e) {}
			}
