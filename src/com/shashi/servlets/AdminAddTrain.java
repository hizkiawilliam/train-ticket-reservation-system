			...
			if(!uName.equals("")||uName!=null) {
				try {
					...
					if(rs.next()) {
						...
						rd.include(req, res);
						pw.println("<div class='tab'><p1 class='menu'>Kereta Berhasil Ditambahkan!</p1></div>");
					}
					else {
						RequestDispatcher rd = req.getRequestDispatcher("AddTrains.html");
						rd.include(req, res);
						pw.println("<div class='tab'><p1 class='menu'>Error daam mengisi detail Kereta</p1></div>");
					}
				}
				catch(Exception e) {}				
			}
