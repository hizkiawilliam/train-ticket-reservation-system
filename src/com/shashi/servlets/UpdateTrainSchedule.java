			...
			if(!uName.equals("")||uName!=null) {
				try {
					...
					if(rs.next()) {
						...
						rd.include(req, res);
						pw.println("<div class='tab'><p1 class='menu'>Kereta berhasil diperbarui!</p1></div>");
					}
					else {
						RequestDispatcher rd = req.getRequestDispatcher("AdminUpdateTrain.html");
						rd.include(req, res);
						pw.println("<div class='tab'><p1 class='menu'>Error pada pengisian detail kereta!</p1></div>");
					}
				}
				catch(Exception e) {}				
			}
