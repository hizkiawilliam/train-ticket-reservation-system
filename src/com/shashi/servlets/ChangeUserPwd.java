				...
				if(uName.equals(u_Name))
				{
					if(pWord.equals(oldPWord))
					{
						...
						if(k==1) {
							...
							ck2.setMaxAge(0);
							res.addCookie(ck2);
							pw.println("<div class='tab'>Username dan Password anda sudah diperbarui!<br/>Harap Login Kembali!</div>");
						}
						else {
							...
							pw.println("<div class='main'><p1 class='menu'><a href='viewuserprofile'>view Profile</a></p1>"
									...
									+ "</div>");
							pw.println("<div class='tab'>Username atau password lama anda salah!</div>");
						}
					}
					else {
						RequestDispatcher rd = req.getRequestDispatcher("UserHome.html");
						...
						pw.println("<div class='main'><p1 class='menu'><a href='viewuserprofile'>lihat Profile</a></p1>"
								...
								+ "</div>");
						pw.println("<div class='tab'>Password lama salah!</div>");
						}
				}	
				else {
					RequestDispatcher rd = req.getRequestDispatcher("UserHome.html");
